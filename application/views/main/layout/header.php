            ...
            <div class="container">
                <div class="nk-nav-table">
                    <a href="<?= base_url('home') ?>" class="nk-nav-logo">
                        <img src="<?= base_url() ?>/assets/goodgames/assets/images/settings/<?= $this->darkblowsettings->load()->project_logo ?>" alt="<?= $this->darkblowsettings->load()->project_name ?>" width="199">
                    </a>
    ...
    <div id="nk-nav-mobile" class="nk-navbar nk-navbar-side nk-navbar-right-side nk-navbar-overlay-content d-lg-none">
        <div class="nano">
            <div class="nano-content">
                <a href="<?= base_url('home') ?>" class="nk-nav-logo">
                    <img src="<?= base_url() ?>/assets/goodgames/assets/images/settings/<?= $this->darkblowsettings->load()->project_logo ?>" alt="" width="120">
                </a>
