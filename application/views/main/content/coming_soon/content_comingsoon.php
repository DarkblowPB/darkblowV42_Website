...
<head>
    ...
    <title>DarkblowPB || Coming Soon</title>
...
<body>
        ...
        <div class="nk-fullscreen-block">
            ...
            <div class="nk-fullscreen-block-middle">
                <div class="container text-center">
                    ...
                    <div class="nk-gap-2"></div>
                    <div class="nk-countdown nk-countdown-center" data-end="2021-01-02 15:00:00" data-timezone="WIB"></div>
                    <div class="nk-gap-2"></div>
    ...
    <div class="nk-page-background-fixed" style="background-image: url('<?php echo base_url() ?>assets/goodgames/assets/images/bg-fixed-1.jpg');"></div>
    <!-- END: Page Background -->
