<div class="nk-main">
	<div class="container">
		...
		<h3 class="nk-decorated-h-2">
			<span>
				<span class="text-main-1"><?= $this->lang->line('STR_DARKBLOW_146') ?></span>
							...
							<div class="pl-5 pr-5">
								<div class="nk-product-cat-3">
									...
									<div class="nk-product-cont">
										...
										<div class="nk-gap-1"></div>
										<div class="nk-product-price">&#8373; <?= number_format($row['webshop_itemprice_30days'], 0, ',', '.') ?></div>
									</div>
								</div>
							</div>
						</div>
		...
		<?php if ($popular == null) : ?>
			<div clas="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center"><?= $this->lang->line('STR_INFO_4') ?></div>
			</div>
		<?php endif; ?>
		<div class="nk-gap-2"></div>
		<h3 class="nk-decorated-h-2">
			<span>
				<span class="text-main-1"><?= $this->lang->line('STR_DARKBLOW_148') ?></span>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-12">
						<div class="nk-product-cat">
							...
							<div class="nk-product-cont">
								...
								<div class="nk-product-price">&#8373; <?= number_format($row['webshop_itemprice_30days'], 0, ',', '.') ?></div>
								<div class="nk-gap-1"></div>
								<a href="<?= base_url('webshop/details/' . $row['id']) ?>" class="nk-btn nk-btn-rounded nk-btn-outline nk-btn-color-main-1 btn-block"><i class="fa fa-shopping-cart mr-2"></i><?= $this->lang->line('STR_DARKBLOW_207') ?></a>
							</div>
						</div>
					</div>
				<?php endforeach; ?>
