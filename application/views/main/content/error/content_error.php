...
<head>
    ...
    <!-- FontAwesome -->
    <script defer src="<?php echo base_url() ?>/assets/goodgames/<?php echo base_url() ?>/assets/goodgames/assets/vendor/fontawesome-free/js/all.js"></script>
    <script defer src="<?php echo base_url() ?>/assets/goodgames/<?php echo base_url() ?>/assets/goodgames/assets/vendor/fontawesome-free/js/v4-shims.js"></script>
    ...
    <!-- Photoswipe -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/assets/goodgames/assets/vendor/photoswipe/dist/photoswipe.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/assets/goodgames/assets/vendor/photoswipe/dist/default-skin/default-skin.css">
    ...
    <!-- Summernote -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>/assets/goodgames/assets/vendor/summernote/dist/summernote-bs4.css">
...
<!-- Jarallax -->
<script src="<?php echo base_url() ?>/assets/goodgames/assets/vendor/jarallax/dist/jarallax.min.js"></script>
<script src="<?php echo base_url() ?>/assets/goodgames/assets/vendor/jarallax/dist/jarallax-video.min.js"></script>
...
<!-- Photoswipe -->
<script src="<?php echo base_url() ?>/assets/goodgames/assets/vendor/photoswipe/dist/photoswipe.min.js"></script>
<script src="<?php echo base_url() ?>/assets/goodgames/assets/vendor/photoswipe/dist/photoswipe-ui-default.min.js"></script>
...
<!-- NanoSroller -->
<script src="<?php echo base_url() ?>/assets/goodgames/assets/vendor/nanoscroller/bin/javascripts/jquery.nanoscroller.js"></script>

<!-- SoundManager2 -->
<script src="<?php echo base_url() ?>/assets/goodgames/assets/vendor/soundmanager2/script/soundmanager2-nodebug-jsmin.js"></script>

<!-- Seiyria Bootstrap Slider -->
<script src="<?php echo base_url() ?>/assets/goodgames/assets/vendor/bootstrap-slider/dist/bootstrap-slider.min.js"></script>

<!-- Summernote -->
<script src="<?php echo base_url() ?>/assets/goodgames/assets/vendor/summernote/dist/summernote-bs4.min.js"></script>

<!-- nK Share -->
<script src="<?php echo base_url() ?>/assets/goodgames/assets/plugins/nk-share/nk-share.js"></script>
