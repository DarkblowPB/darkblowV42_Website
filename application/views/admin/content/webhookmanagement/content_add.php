<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
        <?= form_open('', 'autocomplete="off" id="addwebhook_form"') ?>
        <div class="card">
            <div class="card-body">
                <div class="form-group">
                    <label for="url">Webhook URL</label>
                    <input type="url" name="url" id="url" class="form-control" placeholder="Webhook URL">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="avatar_url" id="avatar_url" class="form-control" placeholder="Avatar URL">
                    <small class="form-text text-muted font-weight-bold">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="embeds_title" id="embeds_title" class="form-control" placeholder="Embeds Title">
                </div>
                <div class="form-group">
                    <label for="embeds_description">Embeds Description</label>
                    <textarea name="embeds_description" id="embeds_description" rows="10" class="form-control" placeholder="Embeds Description"></textarea>
                </div>
                <div class="form-group">
                    ...
                    <select name="type" id="type" class="form-control reward_selection" style="width: 100%;">
                        ...
                        <option value="<?= Darkblowwebhook::REDEEMCODE_WEBHOOK ?>">Redeem Code Webhook</option>
                        <option value="<?= Darkblowwebhook::REGISTER_WEBHOOK ?>">Register Webhook</option>
                    </select>
                </div>
                <div class="form-group">
            ...
            <div class="card-footer text-right">
                <input type="submit" id="submit" class="btn btn-outline-primary" value="Add New Webhook">
            </div>
        </div>
        <?= form_close() ?>
        <script>
            ...
            function AddNewWebhook() {
                ...
                $.ajax({
                    url: '<?= base_url('adm/webhookmanagement/do_add') ?>',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                    ...
                    success: (response) => {
                        ...
                        SetAttribute('submit', 'submit', 'Add New Webhook');
