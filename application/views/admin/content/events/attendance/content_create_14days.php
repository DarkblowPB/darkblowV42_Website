        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-3">Reward Day 8</label>
                        <select id="reward_day_8" class="form-control col-9 reward_selection">
                            <option value="" disabled selected>Select Your Reward</option>
                            <?php foreach ($reward as $row) : ?>
                                <option value="<?php echo $row['item_id'] ?>"><?php echo $row['item_name'] ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-3">Reward Day 9</label>
                        <select id="reward_day_9" class="form-control col-9 reward_selection">
                            <option value="" disabled selected>Select Your Reward</option>
                            <?php foreach ($reward as $row) : ?>
                                <option value="<?php echo $row['item_id'] ?>"><?php echo $row['item_name'] ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-3">Reward Day 10</label>
                        <select id="reward_day_10" class="form-control col-9 reward_selection">
                            <option value="" disabled selected>Select Your Reward</option>
                            <?php foreach ($reward as $row) : ?>
                                <option value="<?php echo $row['item_id'] ?>"><?php echo $row['item_name'] ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-3">Reward Day 11</label>
                        <select id="reward_day_11" class="form-control col-9 reward_selection">
                            <option value="" disabled selected>Select Your Reward</option>
                            <?php foreach ($reward as $row) : ?>
                                <option value="<?php echo $row['item_id'] ?>"><?php echo $row['item_name'] ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-3">Reward Day 12</label>
                        <select id="reward_day_12" class="form-control col-9 reward_selection">
                            <option value="" disabled selected>Select Your Reward</option>
                            <?php foreach ($reward as $row) : ?>
                                <option value="<?php echo $row['item_id'] ?>"><?php echo $row['item_name'] ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-3">Reward Day 13</label>
                        <select id="reward_day_13" class="form-control col-9 reward_selection">
                            <option value="" disabled selected>Select Your Reward</option>
                            <?php foreach ($reward as $row) : ?>
                                <option value="<?php echo $row['item_id'] ?>"><?php echo $row['item_name'] ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-3">Reward Day 14</label>
                        <select id="reward_day_14" class="form-control col-9 reward_selection">
                            <option value="" disabled selected>Select Your Reward</option>
                            <?php foreach ($reward as $row) : ?>
                                <option value="<?php echo $row['item_id'] ?>"><?php echo $row['item_name'] ?></option>
                            <?php endforeach; ?>
                    ...
                    <script>
                        ...
                        function CreateEvents() {
                            if ($('#reward_day_1').val() == '' || $('#reward_day_1').val() == null) {
                                ...
                                return;
                            } else if ($('#reward_day_8').val() == '' || $('#reward_day_8').val() == null) {
                                ShowToast(2000, 'warning', 'Reward Day 7 Cannot Be Empty.');
                                return;
                            } else if ($('#reward_day_9').val() == '' || $('#reward_day_9').val() == null) {
                                ShowToast(2000, 'warning', 'Reward Day 7 Cannot Be Empty.');
                                return;
                            } else if ($('#reward_day_10').val() == '' || $('#reward_day_10').val() == null) {
                                ShowToast(2000, 'warning', 'Reward Day 7 Cannot Be Empty.');
                                return;
                            } else if ($('#reward_day_11').val() == '' || $('#reward_day_11').val() == null) {
                                ShowToast(2000, 'warning', 'Reward Day 7 Cannot Be Empty.');
                                return;
                            } else if ($('#reward_day_12').val() == '' || $('#reward_day_12').val() == null) {
                                ShowToast(2000, 'warning', 'Reward Day 7 Cannot Be Empty.');
                                return;
                            } else if ($('#reward_day_13').val() == '' || $('#reward_day_13').val() == null) {
                                ShowToast(2000, 'warning', 'Reward Day 7 Cannot Be Empty.');
                                return;
                            } else if ($('#reward_day_14').val() == '' || $('#reward_day_14').val() == null) {
                                ShowToast(2000, 'warning', 'Reward Day 7 Cannot Be Empty.');
                                return;
                            } else {
                                ...
                                $.ajax({
                                    url: '<?php echo base_url('adm/eventsmanagement/attendance/do_create14days') ?>',
                                    type: 'POST',
                                    dataType: 'JSON',
                                    data: {
                                        ...
                                        'reward_day_8': $('#reward_day_8').val(),
                                        'reward_day_9': $('#reward_day_9').val(),
                                        'reward_day_10': $('#reward_day_10').val(),
                                        'reward_day_11': $('#reward_day_11').val(),
                                        'reward_day_12': $('#reward_day_12').val(),
                                        'reward_day_13': $('#reward_day_13').val(),
                                        'reward_day_14': $('#reward_day_14').val(),
