                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <a href="<?= base_url('adm/newsmanagement/details?post_id=' . $row['id']) ?>" class="dropdown-item">Details</a>
                                                <a href="<?= base_url('adm/newsmanagement/edit?news_id=' . $row['id']) ?>" class="dropdown-item">Edit</a>
