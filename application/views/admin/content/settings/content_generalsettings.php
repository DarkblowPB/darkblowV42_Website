                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <select id="server_condition" class="form-control col-9 reward_selection">
                            ...
                            <option value="1" <?php if ($settings->server_condition == 1) {
                                                    echo 'selected';
                                                } ?>>ONLINE</option>
                        </select>
                    </div>
                    <div class="form-group row">
                        ...
                        <select id="website_condition" class="form-control col-9 reward_selection">
                            ...
                            <option value="1" <?php if ($settings->website_condition == 1) {
                                                    echo 'selected';
                                                } ?>>ONLINE</option>
                        </select>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" id="project_name" class="form-control col-9" value="<?= $settings->project_name ?>" placeholder="Enter Your Project Name">
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-3">Meta Author</label>
                        <input type="text" id="meta_author" class="form-control col-9" value="<?= $settings->meta_author ?>" placeholder="Enter Your Meta Author">
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-3">Meta Description</label>
                        <input type="text" id="meta_description" class="form-control col-9" value="<?= $settings->meta_description ?>" placeholder="Enter Your Meta Description">
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-3">Meta Keywords</label>
                        <input type="text" id="meta_keywords" class="form-control col-9" value="<?= $settings->meta_keywords ?>" placeholder="Enter Your Meta Keywords (Separate With Comma)">
                    </div>
                    <div class="form-group row">
                    ...
                    <form id="generalsettings03_form" autocomplete="off">
                        ...
                        <?php if ($settings->project_logo != null) : ?>
                            <div class="form-group row">
                                ...
                                <img src="<?= base_url() ?>assets/goodgames/assets/images/settings/<?= $settings->project_logo ?>" class="img img-fluid" width="250" alt="<?= $settings->project_logo ?>">
                            </div>
                        <?php endif; ?>
                        <div class="form-group row">
                        ...
                        <?php if ($settings->project_icon != null) : ?>
                            <div class="form-group row">
                                ...
                                <img src="<?= base_url() ?>assets/goodgames/assets/images/settings/<?= $settings->project_icon ?>" class="img img-fluid" width="250" alt="<?= $settings->project_icon ?>">
                            </div>
                        <?php endif; ?>
                        <div class="form-group text-right">
