            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="file_name" class="form-control" value="<?php echo $files->file_name ?>" placeholder="Enter Your File Name">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">File URL</label>
                        <input type="url" id="file_url" class="form-control" value="<?php echo $files->file_url ?>" placeholder="Enter Your File URL">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="file_size" class="form-control" placeholder="Enter Your File Size" value="<?php echo $files->size ?>">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">File Version (<span class="text-danger">Optional</span>)</label>
                        <input type="text" id="file_version" class="form-control" placeholder="Enter Your File Version" value="<?php echo $files->version ?>">
                    </div>
