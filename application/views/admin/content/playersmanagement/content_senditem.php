<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-body">
                    <?php echo form_open('', 'id="senditem_form" autocomplete="off"') ?>
                        <div class="form-group row">
                            ...
                            <select id="player_id" class="form-control col-9 reward_selection">
                                ...
                                <?php foreach ($players as $row) : ?>
                                    <option value="<?php echo $row['player_id'] ?>"><?php if ($row['player_name'] == ''){echo $row['login'];}else{echo $row['player_name'];} ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group row">
            ...
            <script>
                ...
                function Do_SendItem()
                {
                    if ($('#player_id').val() == '' || $('#player_id').val() == null){
                        ...
                        $.ajax({
                            url: '<?php echo base_url('adm/playersmanagement/do_senditem') ?>',
                            type: 'POST',
                            dataType: 'JSON',
                            data:{
